...
public class GenderSection {
    ...
    private final By maleRadioButton = new By.ById("gender-radio-1");
    private final By femaleRadioButton = new By.ById("gender-radio-2");
    private final By otherRadioButton = new By.ById("gender-radio-3");
